...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColCaption = array("Fullname", "Gender", "National ID", "Phone number", "Email", "Registration date", "House", "Agreement document", "Status", "Exit date","Action");
	$x->ColFieldName = array('fullname', 'gender', 'national_id', 'phone_number', 'email', 'registration_date', 'house', 'agreement_document', 'status', 'exit_date','action');
